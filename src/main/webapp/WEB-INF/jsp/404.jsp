				...
				<div class="m-content">
					<div class="row">
                            <div class="col-md-12 page-404">
                                ...
                                <div class="details">
                                    <h3 style="font-size:24px;font-weight:100">Oops! You're lost.</h3>
                                    <p style="font-size:15px;"> We can not find the page you're looking for.  
                                        <br>
